...
int16_t Gamepad::status(unsigned index, unsigned id) const {
  ...
  switch(id) {
    case (unsigned int)SNES::Input::JoypadID::Up: return up.cachedState;
    case (unsigned int)SNES::Input::JoypadID::Down: return  down.cachedState;
    case (unsigned int)SNES::Input::JoypadID::Left: return left.cachedState;
    case (unsigned int)SNES::Input::JoypadID::Right: return  right.cachedState;
    case (unsigned int)SNES::Input::JoypadID::A: return  a.cachedState | turboA.cachedState;
    case (unsigned int)SNES::Input::JoypadID::B: return  b.cachedState | turboB.cachedState;
    case (unsigned int)SNES::Input::JoypadID::X: return  x.cachedState | turboX.cachedState;
    case (unsigned int)SNES::Input::JoypadID::Y: return  y.cachedState | turboY.cachedState;
    case (unsigned int)SNES::Input::JoypadID::L: return  l.cachedState | turboL.cachedState;
    case (unsigned int)SNES::Input::JoypadID::R: return  r.cachedState | turboR.cachedState;
    case (unsigned int)SNES::Input::JoypadID::Select: return  select.cachedState;
    case (unsigned int)SNES::Input::JoypadID::Start: return start.cachedState;
  }
  return 0;
}
...
int16_t Asciipad::status(unsigned index, unsigned id) const {
  ...
  switch(id) {
    case (int16_t) SNES::Input::JoypadID::Up: return (unsigned int) up.cachedState;
    case (int16_t) SNES::Input::JoypadID::Down: return (unsigned int) down.cachedState;
    case (int16_t) SNES::Input::JoypadID::Left: return (unsigned int) left.cachedState;
    case (int16_t) SNES::Input::JoypadID::Right: return (unsigned int) right.cachedState;
    case (int16_t) SNES::Input::JoypadID::A: return (unsigned int) a.cachedState;
    case (int16_t) SNES::Input::JoypadID::B: return (unsigned int) b.cachedState;
    case (int16_t) SNES::Input::JoypadID::X: return (unsigned int) x.cachedState;
    case (int16_t) SNES::Input::JoypadID::Y: return (unsigned int) y.cachedState;
    case (int16_t) SNES::Input::JoypadID::L: return (unsigned int) l.cachedState;
    case (int16_t) SNES::Input::JoypadID::R: return (unsigned int) r.cachedState;
    case (int16_t) SNES::Input::JoypadID::Select: return (unsigned int) select.cachedState;
    case (int16_t) SNES::Input::JoypadID::Start: return (unsigned int) start.cachedState | slowMotion.cachedState;
  }
  return 0;
}
...
int16_t Mouse::status(unsigned index, unsigned id) const {
  switch(id) {
    case (int16_t) SNES::Input::MouseID::X: return x.cachedState;
    case (int16_t) SNES::Input::MouseID::Y: return y.cachedState;
    case (int16_t) SNES::Input::MouseID::Left: return left.cachedState;
    case (int16_t) SNES::Input::MouseID::Right: return right.cachedState;
  }
  return 0;
}
...
int16_t SuperScope::status(unsigned index, unsigned id) const {
  switch(id) {
    case (int16_t) SNES::Input::SuperScopeID::X: return x.cachedState;
    case (int16_t) SNES::Input::SuperScopeID::Y: return y.cachedState;
    case (int16_t) SNES::Input::SuperScopeID::Trigger: return trigger.cachedState;
    case (int16_t) SNES::Input::SuperScopeID::Cursor: return cursor.cachedState;
    case (int16_t) SNES::Input::SuperScopeID::Turbo: return turbo.cachedState;
    case (int16_t) SNES::Input::SuperScopeID::Pause: return pause.cachedState;
  }
  return 0;
}
...
int16_t Justifier::status(unsigned index, unsigned id) const {
  switch(id) {
    case (int16_t) SNES::Input::JustifierID::X: return x.cachedState;
    case (int16_t) SNES::Input::JustifierID::Y: return y.cachedState;
    case (int16_t) SNES::Input::JustifierID::Trigger: return trigger.cachedState;
    case (int16_t) SNES::Input::JustifierID::Start: return start.cachedState;
  }
  return 0;
}
